...
namespace RestaurantManagementProject.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DepartmentId,DepartmentName,DepartmentManager,DepartmentSalary")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DepartmentId,DepartmentName,DepartmentManager,DepartmentSalary")] Department department)
        {
